...
class MyTracker():
    ...
    def initframe(self, frame, init_rect):
        ...
        init_rect1[2] = int(init_rect1[2] * 1.3)
        init_rect1[3] = int(init_rect1[3] * 1.2)
        if init_rect1[0] < 0:
    ...
    def track(self, frame):
        ...
        while True:
            ...
            # cv2.imshow('self.roi', self.img_roi)
            # cv2.waitKey(1)
            ...
            if self.detection_obj:
                ...
                if num != self.num_init and num != -1 :
                ...
                # break
            outputs['count'] = self.frame_count
