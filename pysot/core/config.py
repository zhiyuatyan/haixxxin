...
__C.DATASET.NAMES = ('HX1', 'HX2', 'HX3')
__C.DATASET.HX1 = CN()
__C.DATASET.HX1.ROOT = 'training_dataset/HX1/crop511'
__C.DATASET.HX1.ANNO = 'training_dataset/HX1/train.json'
__C.DATASET.HX1.FRAME_RANGE = 3
__C.DATASET.HX1.NUM_USE = -1  # repeat until reach NUM_USE

__C.DATASET.HX2 = CN()
__C.DATASET.HX2.ROOT = 'training_dataset/HX2/crop511'
__C.DATASET.HX2.ANNO = 'training_dataset/HX2/train.json'
__C.DATASET.HX2.FRAME_RANGE = 3
__C.DATASET.HX2.NUM_USE = -1  # repeat until reach NUM_USE

__C.DATASET.HX3 = CN()
__C.DATASET.HX3.ROOT = 'training_dataset/HX3/crop511'
__C.DATASET.HX3.ANNO = 'training_dataset/HX3/train.json'
__C.DATASET.HX3.FRAME_RANGE = 3
__C.DATASET.HX3.NUM_USE = -1  # repeat until reach NUM_USE
...
__C.DATASET.VIDEOS_PER_EPOCH = 15000
# ------------------------------------------------------------------------ #
# Backbone options
# ------------------------------------------------------------------------ #
__C.BACKBONE = CN()
...
__C.BACKBONE.PRETRAINED = 'models/resnet50.siamprn++'
